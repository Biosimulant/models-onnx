...
"""Imported BioImage ONNX wrapper for HPA Bestfitting InceptionV3."""
...
class BioimageHpaBestfittingInceptionv3(BioModule):
    """Run the imported HPA InceptionV3 ONNX graph as a BioModule."""
    ...
    def __init__(
        ...
        input_shape: Sequence[int] = (1, 4, 128, 128),
        class_dim: int = 19,
