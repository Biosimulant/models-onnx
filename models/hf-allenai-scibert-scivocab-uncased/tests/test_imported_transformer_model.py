...
from src.imported_transformer_model import HfAllenaiScibertScivocabUncased
...
def test_imported_transformer_model_emits_sequence_and_pooled_outputs() -> None:
    ...
    model = HfAllenaiScibertScivocabUncased(session_factory=_FakeSession, seq_length=4)
