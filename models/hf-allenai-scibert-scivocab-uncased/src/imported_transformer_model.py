...
"""Imported transformer ONNX wrapper for scibert_scivocab_uncased."""
...
class HfAllenaiScibertScivocabUncased(BioModule):
    """Run the imported SciBERT ONNX export behind the BioModule interface."""
        ...
        self._outputs = {
            self.sequence_port: BioSignal(
                ...
                metadata=SignalMetadata(
                    description="scibert_scivocab_uncased token-level embedding tensor",
                    dtype="float32",
            ...
            self.pooled_port: BioSignal(
                ...
                time=t,
                metadata=SignalMetadata(
                    description="scibert_scivocab_uncased pooled embedding vector",
                    dtype="float32",
                    shape=(1, 768),
                    kind="state",
                ),
