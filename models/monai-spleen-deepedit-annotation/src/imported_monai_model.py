...
"""Imported MONAI ONNX wrapper for Spleen DeepEdit Annotation."""
...
class MonaiSpleenDeepeditAnnotation(BioModule):
    """Run the imported DeepEdit annotation ONNX graph as a BioModule."""
    ...
    def __init__(
        ...
        input_shape: Sequence[int] = (1, 3, 128, 128, 128),
        output_shape: Sequence[int] = (1, 2, 128, 128, 128),
    ...
    def advance_to(self, t: float) -> None:
        ...
        self._outputs = {
            self.output_port: BioSignal(
                ...
                value=prediction,
                time=t,
                metadata=SignalMetadata(description="Spleen DeepEdit Annotation output tensor", dtype="float32", shape=self.output_shape, kind="state"),
            ),
