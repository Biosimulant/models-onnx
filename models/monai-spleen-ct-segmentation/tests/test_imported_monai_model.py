...
from src.imported_monai_model import MonaiSpleenCtSegmentation
...
def test_imported_monai_model_emits_prediction_and_summary() -> None:
    ...
    model = MonaiSpleenCtSegmentation(session_factory=_FakeSession, input_shape=(1, 1, 8, 8, 8), output_shape=(1, 1, 8, 8, 8))
