...
"""Imported MONAI ONNX wrapper for Pancreas CT DINTS Segmentation."""
...
class MonaiPancreasCtDintsSegmentation(BioModule):
    """Run the imported pancreas DiNTS ONNX graph as a BioModule."""
    ...
    def __init__(
        ...
        output_shape: Sequence[int] = (1, 3, 96, 96, 96),
    ...
    def advance_to(self, t: float) -> None:
        ...
        self._outputs = {
            self.output_port: BioSignal(
                ...
                value=prediction,
                time=t,
                metadata=SignalMetadata(description="Pancreas CT DINTS Segmentation output tensor", dtype="float32", shape=self.output_shape, kind="state"),
            ),
