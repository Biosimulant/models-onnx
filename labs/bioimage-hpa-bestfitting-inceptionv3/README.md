...
Human Protein Atlas image classification and feature embedding from a BioImage.io InceptionV3 ONNX graph.

## Source And Artifact

- `rdf`: https://bioimage-io.github.io/collection-bioimage-io/rdfs/10.5281/zenodo.5910854/6539073/rdf.yaml
- `onnx`: https://zenodo.org/api/records/6539073/files/bestfitting-inceptionv3-single-cell.onnx/content
...
> What class-score and embedding tensors does this source HPA InceptionV3 graph emit for the supplied preprocessed cell image tensor?
...
![Bioimage Hpa Bestfitting Inceptionv3 - source-faithful ONNX run](assets/01-bioimage-hpa-bestfitting-inceptionv3-source-faithful-onnx-run.png)
