...
from src.imported_bioimage_model import BioimageHpaBestfittingInceptionv3
...
def test_imported_bioimage_model_emits_class_and_feature_outputs() -> None:
    ...
    model = BioimageHpaBestfittingInceptionv3(session_factory=_FakeSession, input_shape=(1, 4, 16, 16))
