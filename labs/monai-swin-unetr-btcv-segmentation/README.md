...
BTCV multi-organ CT segmentation exported from a MONAI Swin UNETR bundle.

## Source And Artifact

- `bundle`: https://api.ngc.nvidia.com/v2/models/nvidia/monaihosting/swin_unetr_btcv_segmentation/versions/0.1.0/files/swin_unetr_btcv_segmentation_v0.1.0.zip
...
> What segmentation prediction tensor does the source MONAI BTCV ONNX export emit for this CT volume tensor?
...
![Monai Swin Unetr Btcv Segmentation - source-faithful ONNX run](assets/01-monai-swin-unetr-btcv-segmentation-source-faithful-onnx-run.png)
...
Synthetic input validates ONNX execution only; organ-label interpretation requires source label metadata.
