...
Spleen CT segmentation exported from a MONAI bundle.
...
> What segmentation prediction tensor does the source MONAI spleen CT ONNX export emit for this CT volume tensor?
...
![Monai Spleen Ct Segmentation - source-faithful ONNX run](assets/01-monai-spleen-ct-segmentation-source-faithful-onnx-run.png)
