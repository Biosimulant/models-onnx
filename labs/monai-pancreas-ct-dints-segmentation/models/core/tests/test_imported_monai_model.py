...
from src.imported_monai_model import MonaiPancreasCtDintsSegmentation
...
def test_imported_monai_model_emits_prediction_and_summary() -> None:
    signal = type("Sig", (), {"value": [[[[[0.0] * 8 for _ in range(8)] for _ in range(8)]]],})()
    model = MonaiPancreasCtDintsSegmentation(session_factory=_FakeSession, input_shape=(1, 1, 8, 8, 8), output_shape=(1, 3, 8, 8, 8))
